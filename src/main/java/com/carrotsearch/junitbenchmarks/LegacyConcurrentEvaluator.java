...
/**
  ...
  */
 final class LegacyConcurrentEvaluator extends LegacyBaseEvaluator
 {
   ...
   private final class EvaluatorCallable implements Callable<Void>
     ...
     LegacyConcurrentEvaluator(BenchmarkStatement benchmarkStatement, int warmupRounds, int benchmarkRounds, int totalRounds,
